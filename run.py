...
def main():
    print("\n" + "=" * 60)
    print("🤖 TECHBOT - Advanced NLP Tech Assistant")
    print("=" * 60)
    ...
    print("\n💡 Tips:")
    print("  • Ask any tech question (company/country/AI/cyber/etc.)")
    ...
    if profile["knowledge_level"] == "beginner" and not profile["interests"]:
        ...
        if setup == "y":
            ...
            interests = input("Interests (comma-separated, e.g., ai,web,data): ").lower().strip()
    ...
    print(f"\nHello {user_id}! Ask me about **any tech worldwide**.\n")
    ...
    while True:
        try:
            ...
            if cmd == "help":
                ...
                print("  done <kw>   - mark suggested resources done (e.g., done coursera)")
                print("  quit        - exit")
                print("\n💡 Examples:")
                print("  what's going on with NVIDIA")
                print("  what's new in UK tech")
                print("  latest AI news + resources for beginners")
                print("  explain RAG and how I can use it in my course")
                continue
            ...
            # Normal chat (respond() already saves turn + updates memory)
